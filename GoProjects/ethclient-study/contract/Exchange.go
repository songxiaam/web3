...
//
// Solidity: event LogCancel(address indexed maker, address indexed feeReciptient, address makerToken, address takerToken, uint256 cancelledMakerTokenAmount, uint256 cancelledTakerTokenAmount, bytes32 indexed tokens, bytes32 orderHash)
func (_Exchange *ExchangeFilterer) FilterLogCancel(opts *bind.FilterOpts, maker []common.Address, feeReciptient []common.Address, tokens [][32]byte) (*ExchangeLogCancelIterator, error) {

	var makerRule []interface{}
	for _, makerItem := range maker {
		makerRule = append(makerRule, makerItem)
	}
	var feeReciptientRule []interface{}
	for _, feeReciptientItem := range feeReciptient {
		feeReciptientRule = append(feeReciptientRule, feeReciptientItem)
	}
	...
	logs, sub, err := _Exchange.contract.FilterLogs(opts, "LogCancel", makerRule, feeReciptientRule, tokensRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event LogCancel(address indexed maker, address indexed feeReciptient, address makerToken, address takerToken, uint256 cancelledMakerTokenAmount, uint256 cancelledTakerTokenAmount, bytes32 indexed tokens, bytes32 orderHash)
func (_Exchange *ExchangeFilterer) WatchLogCancel(opts *bind.WatchOpts, sink chan<- *ExchangeLogCancel, maker []common.Address, feeReciptient []common.Address, tokens [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Exchange.contract.WatchLogs(opts, "LogCancel", makerRule, feeReciptientRule, tokensRule)
	if err != nil {
		return nil, err
	}
